...
public:
    ...
    ///
    big_integer(integer auto value) {
    ...
    ///
    big_integer(const char* value, radix_type radix) : radix_{radix} {
    ...
    /// @param value std::string literal value.
    ///
    big_integer(const char* value) : big_integer{value, radix_type{radix_flag::decimal}} { }
    ...
    /// @param radix The base of a system of number.
    ///
    big_integer(std::string value, radix_flag radix) : radix_{radix} {
        *this = std::move(value);
    }
    ...
    /// @param value std::string value.
    ///
    big_integer(std::string value) : big_integer{std::move(value), radix_flag::decimal} { }
    ...
    /// @return    Constructed object.
    ///
    big_integer& operator=(integer auto rhs) {
    ...
    ///
    static big_integer value_from(integer auto value) {
...
private:
    ...
    static std::string convert_from_base_ten(const big_integer& value, const radix_flag radix) {
